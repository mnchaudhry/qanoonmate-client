...
export const getAdminUsers = (params?: UserAPI.GetAdminUsersRequest) => APIClient.get<UserAPI.GetAdminUsersResponse>('/user/admin/users', { params });
export const blockUser = (params: UserAPI.BlockUserRequest) => APIClient.patch<UserAPI.BlockUserResponse>(`/user/admin/users/${params.id}/block`, { block: params.block });
...
export const getMyChatSessions = () => APIClient.get<API.GetMyChatSessionsResponse>(`/ai/session/get-my-sessions`)
