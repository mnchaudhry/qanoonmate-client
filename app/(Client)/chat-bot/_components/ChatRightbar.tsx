...
const ChatRightbar = ({
    ...
    keyReferences?: { act: string, section: string }[],
    relatedCases?: string[],
                        ...
                        <Card className='py-0' >
                            ...
                            <CardContent className="space-y-2">
                                ...
                                {keyReferences.map((ref, idx) =>
                                    typeof ref === 'object' && ref.act && ref.section ? (
                                        <div key={idx} className="p-2 bg-primary/5 rounded border border-primary/10">
                                            <p className="text-xs font-medium text-primary">{ref.act}</p>
                                            <p className="text-xs text-muted-foreground mt-1">{ref.section}</p>
                                        </div>
                                    ) : (
                                        <div key={idx} className="p-2 bg-primary/5 rounded border border-primary/10">
                                            <p className="text-xs font-medium text-primary">{String(ref)}</p>
                                        </div>
                                    )
                                )}
                            </CardContent>
                            ...
                            <Card className='py-0' >
                                ...
                                <CardContent className="space-y-2">
                                    <div className="p-2 bg-muted rounded text-xs">
                                        ...
                                        <p className="text-muted-foreground mt-1">Written notice required before eviction</p>
                                    </div>
                                    <div className="p-2 bg-muted rounded text-xs">
                                        <p className="font-medium">Tenant Rights</p>
                                        <p className="text-muted-foreground mt-1">Legal protections for renters</p>
                                    </div>
                                </CardContent>
                            </Card>
                        )}
