...
export function LawyerProfileHeader({ lawyer }: LawyerProfileHeaderProps) {
  ...
  const handleVerifyIdentity = () => {
    // Navigate to verification page (assuming it exists at /lawyer/settings or /lawyer/verification)
    router.push('/lawyer/settings?tab=verification');
  };
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-2">
                  <div className="flex items-center justify-start gap-4">
                    <h1 className="capitalize text-2xl font-semibold text-foreground">
                      {lawyer.personalInfo.fullName || `${lawyer.personalInfo.firstname} ${lawyer.personalInfo.lastname}`}
                    </h1>
