          ...
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
            ...
            {message._id == messages[messages.length - 1]._id && (
              <Hint label="Regenerate response">
                <Button
                  ...
                  className="p-1.5 rounded-full hover:bg-accent transition-all duration-200 hover:scale-105"
                >
            ...
            <Hint label="Rate as helpful">
              <Button
                ...
                size="sm"
                onClick={() => onRate("good")}
                className="p-1.5 rounded-full text-green-600 hover:text-green-700 hover:bg-green-50 transition-all duration-200 hover:scale-105"
              >
            ...
            <Hint label="Rate as unhelpful">
              <Button
                ...
                size="sm"
                onClick={() => onRate("bad")}
                className="p-1.5 rounded-full text-red-600 hover:text-red-700 hover:bg-red-50 transition-all duration-200 hover:scale-105"
              >
            ...
            <Hint label="Flag for review">
              <Button
                ...
                size="sm"
                onClick={() => onFlag()}
                className="p-1.5 rounded-full text-orange-600 hover:text-orange-700 hover:bg-orange-50 transition-all duration-200 hover:scale-105"
              >
    ...
    const MessageItem = React.memo(function MessageItem({
                  ...
                  {message.sender == "bot" &&
                    ...
                    quickAction && (
                      <div className="mt-2 pt-2 border-t border-primary/10">
                        <div className="text-primary/70 text-xs font-medium bg-primary/5 px-3 py-2 rounded-lg">
      ...
      return (
        <div
          key={index}
          className={cn(
            "group flex flex-col gap-3 mb-6 animate-in fade-in slide-in-from-bottom-4 duration-500",
        ...
        >
          ...
          {isModel && (
            <div className="flex items-center gap-2 px-1">
              <div className="w-8 h-8 bg-gradient-to-br from-primary/20 to-primary/10 rounded-full flex items-center justify-center ring-2 ring-primary/20 shadow-sm">
          ...
          <div
            className={cn(
              "px-5 py-4 rounded-2xl w-fit max-w-[85%] md:max-w-[80%] shadow-md hover:shadow-lg transition-all duration-200",
              isModel
                ? "bg-gradient-to-br from-background to-muted/20 text-foreground border-2 border-primary/20"
                : "bg-gradient-to-br from-primary/10 to-primary/5 text-foreground border-2 border-primary/30"
            )}
          >
                ...
                <>
                  {isMetadataLoading ? (
                    ...
                    <div className="mt-3 pt-3 border-t border-primary/10">
                      <div className="text-primary/70 text-xs font-medium bg-primary/5 px-3 py-2.5 rounded-lg flex items-start gap-2">
          ...
          {/* Timestamp */}
          {messageTime && (
            <div className="text-xs text-muted-foreground flex items-center gap-1.5 opacity-70 px-1">
              <Clock className="w-3.5 h-3.5" />
              <span>{messageTime}</span>
            </div>
          )}
