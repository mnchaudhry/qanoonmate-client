...
import CountdownItem from '@/components/ui/countdown-timer';
...
const UnderMaintenance: React.FC = () => {
  ...
  return (
    <div className="bg-neutral px-4 dark:bg-boxdark-2 sm:px-6">
          ...
          <div className="no-scrollbar h-screen w-full overflow-y-auto border-stroke dark:border-strokedark lg:w-1/2 lg:border-r xl:flex xl:items-center xl:justify-center">
            <div className="px-4 py-20 xl:px-0">
              <div>
                ...
                <h1 className="mb-2.5 text-3xl font-black text-black dark:text-neutral lg:text-4xl xl:text-[50px] xl:leading-[60px]">
                  Under Maintenance
                </h1>
              ...
              <div className="mt-10">
                <p className="mb-5 font-medium text-black dark:text-neutral">
                  Follow Us On
                </p>
                ...
                <div className="flex items-center gap-4">
                  <Link
                    href="#"
                    className="size-10 flex items-center justify-center rounded-full border border-[#DFE4EA] hover:border-primary hover:bg-primary hover:text-neutral dark:border-strokedark dark:hover:border-primary"
                  >
                    <svg
