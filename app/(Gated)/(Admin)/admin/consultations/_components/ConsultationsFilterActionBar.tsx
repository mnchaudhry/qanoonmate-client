...
const ConsultationsFilterActionBar = ({ search, setSearch, filterStatus, setFilterStatus, showStatusDropdown, setShowStatusDropdown, showBulkActionsDropdown, setShowBulkActionsDropdown, handleExportCSV, handleCalendarView, handleBulkAction, refreshConsultations }: ConsultationsFilterActionBarProps) => {
  return (
    <div className="flex flex-row justify-between items-center mb-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <div className="relative">
          <Button variant='outline' onClick={() => setShowBulkActionsDropdown(!showBulkActionsDropdown)}>
