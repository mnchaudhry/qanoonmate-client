...
export default function AddUserModal({ open, onOpenChange }: AddUserModalProps) {
  ...
  const [form, setForm] = useState({ firstname: '', lastname: '', email: '', phone: '', password: '', role: UserRole.CLIENT as UserRole, releaseChannel: ReleaseChannel.PUBLIC as ReleaseChannel })
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onOpenChange(false)
      setForm({ firstname: '', lastname: '', email: '', phone: '', password: '', role: UserRole.CLIENT, releaseChannel: ReleaseChannel.PUBLIC })
    } finally {
      setSubmitting(false)
    }
  }
